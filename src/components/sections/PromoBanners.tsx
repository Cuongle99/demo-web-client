...
const banners = [
  ...
  { image: "/assets/home-health.png", title: "Thiết bị y tế cho gia đình", points: ["Sản phẩm chính hãng", "Dễ sử dụng", "An toàn - Hiệu quả"], href: "/collections", className: "promo-card--teal" },
];
